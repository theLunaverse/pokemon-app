...
class HowToUseFrame(tk.Frame):
    ...
    def _add_icon(self, app, idx):
        ...
        if photo:
            btn = tk.Label(self.ctrl, image=photo, bg=HIGHLIGHT_COLOR, cursor="hand2", bd=0, highlightthickness=0)
            btn.image = photo
            btn.place(x=x, y=y)
        ...
        lbl = tk.Label(self.ctrl, text=app['name'], font=SUBTITLE_FONT, fg=BG_COLOR, bg=HIGHLIGHT_COLOR)
    ...
    def _build_loc1(self, is_first, is_last):
        if not is_last:
            nxt = tk.Label(self.ctrl, text="Next ↑", font=TUT_BTN_FONT, fg=HIGHLIGHT_COLOR,
                          bg=ACCENT_COLOR, cursor="hand2", padx=TUT_BTN_PAD_X, pady=TUT_BTN_PAD_Y)
        ...
        if not is_first:
            prv = tk.Label(self.ctrl, text="Prev ↓", font=TUT_BTN_FONT, fg=HIGHLIGHT_COLOR,
                          bg=ACCENT_COLOR, cursor="hand2", padx=TUT_BTN_PAD_X, pady=TUT_BTN_PAD_Y)
    ...
    def _build_loc3(self):
        rpt = tk.Label(self.ctrl, text="↻ Repeat", font=TUT_BTN_FONT, fg=HIGHLIGHT_COLOR,
                      bg=ACCENT_COLOR, cursor="hand2", padx=TUT_BTN_PAD_X, pady=TUT_BTN_PAD_Y)
        ...
        ext = tk.Label(self.ctrl, text="Exit ✕", font=TUT_BTN_FONT, fg=HIGHLIGHT_COLOR,
                      bg=INPUT_BG_COLOR, cursor="hand2", padx=TUT_BTN_PAD_X, pady=TUT_BTN_PAD_Y)
